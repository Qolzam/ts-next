                ...
                <ListItem>
                  ...
                  <ListItemSecondaryAction>
                    <Switch
                      ...
                      checked={checked.getIn([UserSettingEnum.send_email_on_comment_post, 'value'], 'false') === 'true'}
                    />
                  </ListItemSecondaryAction>
                </ListItem>
              </List>
...
const mapDispatchToProps = (dispatch: any, ownProps: INotificationSettingProps) => {
  return {
    updateUserSetting: (type: string, setting: object) => dispatch(userSettingActions.dbUpdateUserSetting(type, setting))
  }
}
