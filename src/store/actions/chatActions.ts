...
export const addPlainChatRoomMessages = (messages: any, roomId: string) => {
  return { 
    type: ChatActionType.ADD_PLAIN_CHAT_ROOM_MESSAGES, payload: {messages, roomId}
  }
}
...
export const wsConnect = () => {
  return { 
    type: ChatActionType.WS_CONNECT, payload: {}
  }
}
...
export const asyncCreateChatRequest = (recUserId: string) => {
  return { 
    type: ChatActionType.ASYNC_CREATE_CHAT_REQUEST, payload: {recUserId}
  }
}
...
export const asyncCancelChatRequest = (recUserId: string) => {
  return { 
    type: ChatActionType.ASYNC_CANCEL_CHAT_REQUEST, payload: {recUserId}
  }
}
...
export const asyncIgnoreChatRequest = (reqUserId: string) => {
  return { 
    type: ChatActionType.ASYNC_IGNORE_CHAT_REQUEST, payload: {reqUserId}
  }
}
...
export const asyncAcceptChatRequest = (reqUserId: string) => {
  return { 
    type: ChatActionType.ASYNC_ACCEPT_CHAT_REQUEST, payload: {reqUserId}
  }
}
...
export const asyncJoinChatroom = (roomId: string) => {
  return { 
    type: ChatActionType.ASYNC_JOIN_CHAT_ROOM, payload: {roomId}
  }
}
...
export const setCurrentChat = ( userId: string) => {
  return { 
    type: ChatActionType.SET_CURRENT_CHAT, payload: {userId}
  }
}
...
export const addChatRequest = (userId: string) => {
  return { 
    type: ChatActionType.ADD_CHAT_REQUEST, payload: {userId}
  }
}
...
export const removeChatRequest = (userId: string) => {
  return { 
    type: ChatActionType.REMOVE_CHAT_REQUEST, payload: {userId}
  }
}
...
export const addChatCalling = (userId: string) => {
  return { 
    type: ChatActionType.ADD_CHAT_CALLING, payload: {userId}
  }
}
...
export const removeChatCalling = (userId: string) => {
  return { 
    type: ChatActionType.REMOVE_CHAT_CALLING, payload: {userId}
  }
}
...
export const addChatConnect = (userId: string, room: object) => {
  return { 
    type: ChatActionType.ADD_CHAT_CONNECT, payload: {userId, room}
  }
}
...
export const removeChatConnect = (userId: string) => {
  return { 
    type: ChatActionType.REMOVE_CHAT_CONNECT, payload: {userId}
  }
}
